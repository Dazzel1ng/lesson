class Hero():
    ...
    def show_hero(self):
        """Print all paramaters of this hero"""
...
class SuperHero(Hero):
    ...
    def show_hero(self):
        discription = self.name + "Level is" + str(self.level) +  "Race is:" + self.race + self.race + "Health is" + str(self.health) + "Magic is" + str*(self.magic)   .title()
